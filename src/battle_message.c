...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_COMBOEVO_NEEDSHELP - BATTLESTRINGS_TABLE_START] = sText_CanComboEvolve,
    [STRINGID_COMBOEVO_ALLOWEVOLVE - BATTLESTRINGS_TABLE_START] = sText_ComboMonNames1,
};
