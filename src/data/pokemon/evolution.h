const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MACHOKE]    = {{EVO_COMBO, 36, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_COMBO, 36, SPECIES_GOLEM}},
    [SPECIES_PONYTA]     = {{EVO_LEVEL, 40, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]   = {{EVO_COMBO, 37, SPECIES_SLOWBRO},
                            {EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING}},
    [SPECIES_MAGNEMITE]  = {{EVO_COMBO, 30, SPECIES_MAGNETON}},
    ...
    [SPECIES_ONIX]       = {{EVO_COMBO, 25, SPECIES_STEELIX}},
    ...
    [SPECIES_SPINARAK]   = {{EVO_COMBO, 22, SPECIES_ARIADOS}},
    ...
    [SPECIES_BELDUM]     = {{EVO_COMBO, 20, SPECIES_METANG}},
    [SPECIES_METANG]     = {{EVO_COMBO, 45, SPECIES_METAGROSS}},
};

// Here, param = quantity of specified fuse mons or level of assist mon respectively
const struct Evolution gComboEvolutionTable[][PARTY_SIZE - 1] = {
    [SPECIES_MAGNEMITE]   = {{COMBO_FUSE, 2, SPECIES_MAGNEMITE}},
    [SPECIES_BELDUM]      = {{COMBO_FUSE, 1, SPECIES_BELDUM}},
    [SPECIES_METANG]      = {{COMBO_FUSE, 1, SPECIES_METANG}},
    [SPECIES_MACHOKE]     = {{COMBO_ASSIST, 36, SPECIES_GRAVELER}},
    [SPECIES_GRAVELER]    = {{COMBO_ASSIST, 36, SPECIES_MACHOKE}},
    [SPECIES_SLOWPOKE]    = {{COMBO_FUSE, 1, SPECIES_SHELLDER}},
    [SPECIES_ONIX]        = {{COMBO_ASSIST, 40, SPECIES_LAIRON}},

    // Delete this one, it's proof of concept
    [SPECIES_SPINARAK]    = {{COMBO_FUSE, 1, SPECIES_CATERPIE},
                             {COMBO_FUSE, 1, SPECIES_WEEDLE},
                             {COMBO_FUSE, 1, SPECIES_VENONAT},
                             {COMBO_FUSE, 1, SPECIES_WURMPLE},
                             {COMBO_ASSIST, 1, SPECIES_SPINDA}},
};
