...
const u32 gItemIcon_ZooBall[] = INCBIN_U32("graphics/items/icons/zoo_ball.4bpp.lz");
const u32 gItemIconPalette_ZooBall[] = INCBIN_U32("graphics/items/icon_palettes/heavy_ball.gbapal.lz");
